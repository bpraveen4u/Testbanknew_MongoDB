    ...
    public class DefaultGraphModelBinder : DefaultModelBinder
    {
        public override object BindModel(ControllerContext controllerContext, ModelBindingContext bindingContext)
        {
            ...
            if ((bindingContext.Model.IsCollection())
                && (bindingContext.Model.CollectionGetCount() > 0) && (!controllerContext.RequestContext.HttpContext.Request.Form.AllKeys.Contains(bindingContext.ModelName)))
                return this.BindCollection(controllerContext, bindingContext);
            //else if (bindingContext.ModelName == "testId" || bindingContext.ModelName == "responseId")
            //{
