...
namespace TestBank.Entity
{
    ...
    [CollectionNameAttribute("userAnswers")]
                    ...
                    foreach (var opt in UserOptions)
                    {
                        switch (opt.Type)
                        {
                            ...
                            case OptionType.RadioButton:
                                ...
                                var selOpt = this.Question.Options.SingleOrDefault(o => o.Id.Equals(opt.Id, StringComparison.InvariantCultureIgnoreCase) && o.IsCorrect == true);
                                if (selOpt != null)
                                {
